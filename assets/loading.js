...
const randomLoader = messages[Math.floor(Math.random() * messages.length)];

const loaderSpan = document.createElement('span');
loaderSpan.innerHTML = randomLoader;
loaderSpan.id = "loading-message";
loaderSpan.className = "title";

const loaderDiv = document.createElement('div');
loaderDiv.id = "loader";
loaderDiv.className = "pageloader is-active";
